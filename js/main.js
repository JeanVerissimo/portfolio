...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function switchLanguage(lang) {
        ...
        // Hide all language elements (rest of the site)
        document.querySelectorAll(".lang").forEach(el => el.style.display = "none");

        // Show only the elements of the selected language
        ...
        const activeButton = document.querySelector(`.language-btn[data-lang="${lang}"]`);
        if (activeButton) {
            activeButton.classList.add("active");
        }

        // Hide all modal links and show only the selected language ones
        document.querySelectorAll(".folio-list__item-link").forEach(link => link.style.display = "none");
        document.querySelectorAll(`.folio-list__item-link.lang.${lang}`).forEach(link => link.style.display = "block");
    }
